# OHSU_rois39_w48s5_brainnetcnn_control_baseline_v13_d326a15c

Vista legible generada desde `config.json` (la fuente de verdad). Timestamp: 2026-07-29 15:18:07.
...
- **Accuracy**: 49.62 ± 16.51 %
- **F1-macro**: 46.16 ± 17.96 %
- **AUC**: 50.72 ± 21.96 %
- **Balanced acc.**: 49.67 ± 17.39 %
- **Brecha train−val (accuracy)**: 21.08 pp
