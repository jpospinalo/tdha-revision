# NeuroIMAGE_rois39_w61s6_brainnetcnn_control_baseline_v13_99b8dfba

Vista legible generada desde `config.json` (la fuente de verdad). Timestamp: 2026-07-29 15:16:43.
...
- **Accuracy**: 45.17 ± 23.39 %
- **F1-macro**: 38.25 ± 23.64 %
- **AUC**: 50.00 ± 33.46 %
- **Balanced acc.**: 43.17 ± 23.55 %
- **Brecha train−val (accuracy)**: 36.35 pp
