...
Vista legible generada desde `config.json` (la fuente de verdad). Timestamp: 2026-07-28 15:09:52.
...
- **Accuracy**: 52.18 ± 11.41 %
- **F1-macro**: 50.51 ± 12.30 %
- **AUC**: 53.11 ± 14.56 %
- **Balanced acc.**: 52.24 ± 11.36 %
- **Brecha train−val (accuracy)**: 29.85 pp
- **Época elegida (mediana)**: 300

## Reproducir

```
run_experiment.py --site NYU --roi-set 39 --model brainnetcnn --representation ordered --window-seconds 120 --step-seconds 12 --model-arg e2e=4 e2n=8 dense=8 dropout=0.7 leaky=0.33 l2_reg=0.05 inter_dropout=0.6 --lr 0.0001 --batch-size 32 --epochs 300 --patience 25 --inner-val-frac 0.15 --start-from-epoch 0 --early-stopping-monitor val_loss --early-stopping-min-delta 1e-05 --seed 42 --n-splits 10 --n-repeats 5 --tag control_base_line --verbose
```
