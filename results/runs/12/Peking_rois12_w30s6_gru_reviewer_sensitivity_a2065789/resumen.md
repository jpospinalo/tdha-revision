# Peking_rois12_w30s6_gru_reviewer_sensitivity_a2065789

Vista legible generada desde `config.json` (la fuente de verdad). Timestamp: 2026-08-05 21:43:34.
...
- **F1-macro**: 43.87 ± 9.18 %
- **AUC**: 50.83 ± 12.43 %
- **Balanced acc.**: 51.08 ± 6.02 %
- **Brecha train−val (accuracy)**: 6.45 pp
- **Época elegida (mediana)**: 16
