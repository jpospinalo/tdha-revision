# Peking_rois12_static_lstm_reviewer_sensitivity_da7862e4

Vista legible generada desde `config.json` (la fuente de verdad). Timestamp: 2026-08-05 20:37:40.
...
- **F1-macro**: 43.38 ± 7.99 %
- **AUC**: 55.01 ± 12.05 %
- **Balanced acc.**: 50.83 ± 5.48 %
- **Brecha train−val (accuracy)**: 5.55 pp
- **Época elegida (mediana)**: 123
