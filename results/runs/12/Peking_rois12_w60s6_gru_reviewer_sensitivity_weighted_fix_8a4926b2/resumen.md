# Peking_rois12_w60s6_gru_reviewer_sensitivity_weighted_fix_8a4926b2

Vista legible generada desde `config.json` (la fuente de verdad). Timestamp: 2026-08-07 13:18:14.
...
- **Accuracy**: 55.75 ± 11.29 %
- **F1-macro**: 52.13 ± 11.61 %
- **AUC**: 55.90 ± 12.84 %
- **Balanced acc.**: 54.24 ± 10.26 %
- **Brecha train−val (accuracy)**: 8.50 pp
- **Época elegida (mediana)**: 27
