...
Vista legible generada desde `config.json` (la fuente de verdad). Timestamp: 2026-07-27 16:13:02.
...
- **Accuracy**: 57.44 ± 10.37 %
- **F1-macro**: 55.15 ± 12.20 %
- **AUC**: 60.07 ± 14.77 %
- **Balanced acc.**: 57.53 ± 10.34 %
- **Brecha train−val (accuracy)**: 5.01 pp
