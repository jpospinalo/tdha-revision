# Peking_rois12_w70s6_brainnetcnn_rev32_window140_step12_24b0ab4f

Vista legible generada desde `config.json` (la fuente de verdad). Timestamp: 2026-07-31 01:21:56.
...
- **Representación**: ordered · **Ventana**: 70 TR / 140.0 s · paso 6 TR / 12.0 s · solape 91% · 28 ventanas · rectangular
...
- **Accuracy**: 55.04 ± 12.15 %
- **F1-macro**: 51.80 ± 13.57 %
- **AUC**: 56.84 ± 14.59 %
- **Balanced acc.**: 54.41 ± 12.11 %
- **Brecha train−val (accuracy)**: 11.19 pp
- **Época elegida (mediana)**: 300

## Reproducir

```
run_experiment.py --site Peking --roi-set 12 --model brainnetcnn --representation ordered --window-seconds 140 --step-seconds 12 --model-arg e2e=4 e2n=8 dense=8 dropout=0.7 leaky=0.33 l2_reg=0.05 inter_dropout=0.6 --lr 0.0001 --batch-size 32 --epochs 300 --patience 25 --inner-val-frac 0.15 --start-from-epoch 0 --early-stopping-monitor val_loss --early-stopping-min-delta 1e-05 --seed 42 --n-splits 10 --n-repeats 5 --class-weight --tag rev32_window140_step12 --verbose
```
