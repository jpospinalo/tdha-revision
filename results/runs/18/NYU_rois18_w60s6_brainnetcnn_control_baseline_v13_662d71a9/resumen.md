# NYU_rois18_w60s6_brainnetcnn_control_baseline_v13_662d71a9

Vista legible generada desde `config.json` (la fuente de verdad). Timestamp: 2026-07-28 16:33:45.
...
- **Accuracy**: 56.68 ± 13.20 %
- **F1-macro**: 55.11 ± 13.74 %
- **AUC**: 59.37 ± 15.32 %
- **Balanced acc.**: 56.61 ± 13.16 %
- **Brecha train−val (accuracy)**: 12.31 pp
