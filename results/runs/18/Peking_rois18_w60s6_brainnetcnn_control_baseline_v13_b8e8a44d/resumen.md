# Peking_rois18_w60s6_brainnetcnn_control_baseline_v13_b8e8a44d

Vista legible generada desde `config.json` (la fuente de verdad). Timestamp: 2026-07-28 20:09:34.
...
- **Accuracy**: 58.88 ± 10.26 %
- **F1-macro**: 53.87 ± 12.37 %
- **AUC**: 57.81 ± 14.61 %
- **Balanced acc.**: 55.43 ± 11.02 %
- **Brecha train−val (accuracy)**: 17.24 pp
